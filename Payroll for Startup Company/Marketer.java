...
public class Marketer extends Employee {
  ...
  public void setnumBonuses(int bonus) {
    numBonuses = bonus;
  }
  ...
  //method that adds one to numBonuses instance variable
  ...
  public int yearsTillRetirement() {
    return (int)Math.round(35 - (getYears() + ((double)usedUnpaidVacation / 260) + (((double)usedVacation / 260) * 2)));
  }
